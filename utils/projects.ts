...
export const PROJECTS:IProject[] = [
    ...
    },
    {
        "slug": "twitter-app",
        "title": "Twitter App",
        "description": "Mi primer proyecto utilizando React. Red social parecida a Twitter el cual tiene autenticación, caché, websockets, y lo común en Twitter, crear tweets, eliminarlos, editar tu perfil, recibir notificaciones cuando llega un mensaje o hay evento en un tweet tuyo, etc.",
        "tecnologies": "NodeJS, React, MongoDB, vanilla CSS, Material UI, SocketIO",
        "status": "in-progress",
        "lastUpdate": "18 de Septiembre de 2022",
        "link": "https://github.com/tomihq/twitter-clone-basic"
    },
    {
        "slug": "next-ecommerce",
        "title": "Commerce",
        ...
        "link": "https://github.com/tomihq/tomihq-next-js/tree/teslo-shop"
    },
