    ...
    sm:pb-4 bg-opacity-60 dark:text-gray-100 border-b-2">
        <div className="flex flex-col md:flex-row gap-6 justify-between w-full">
            <div className="flex flex-col w-4/12">
                <h3 className="font-bold text-md text-black">Social Media</h3>
            ...
            <div className="flex flex-col w-4/12">
               <h3 className="font-bold text-md text-black">Contact Me</h3>
               <ul className="text-gray-800 text-sm">
            ...
            <div className="flex flex-col w-4/12">
               <h3 className="font-bold text-md text-black">About my future</h3>
               <ul className="text-gray-800 text-sm">
                    <li>Study</li>
